# wson
fast tiny binary json libaray inspired by bson and message pack，less than 500 line code you can embed in your application with super speed to transfer data in local machine.
