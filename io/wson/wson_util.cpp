...
namespace wson {
    ...
    void utf16_convert_to_utf8_string(uint16_t * utf16, size_t length, std::string& utf8){
        char* dest = new char[length*4 + 4];
        utf16_convert_to_utf8_string(utf16, length, dest, utf8);
        delete [] dest;
    }

    void utf16_convert_to_utf8_quote_string(uint16_t *utf16, size_t length, std::string& utf8){
        char* dest = new char[length*4 + 4];
    ...
    void utf16_convert_to_utf8_string(uint16_t *utf16, size_t length, char* decodingBuffer, std::string& utf8){
        int count = utf16_convert_to_utf8_cstr(utf16, length, decodingBuffer);
        utf8.append(decodingBuffer, count);
    }
    void utf16_convert_to_utf8_quote_string(uint16_t *utf16, size_t length, char* decodingBuffer, std::string& utf8){
        int count = utf16_convert_to_utf8_quote_cstr(utf16, length, decodingBuffer);
        utf8.append(decodingBuffer, count);
    }

    int utf16_convert_to_utf8_cstr(uint16_t * utf16, size_t length, char* buffer){
        char* src = buffer;
        int count =0;
    ...
    int utf16_convert_to_utf8_quote_cstr(uint16_t *utf16, size_t length, char* buffer){
        int count =0;
